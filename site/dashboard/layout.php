<style>
    ...
    .app-user-content__item-content-tab{
        margin: 40px 0;
    }
    .app-user-content__item-content-list{
    ...
    .app-user-content__item-content-list span{
        color: white;
    }
    .fa{
        color: white;
...
<section style="width: 90%; margin: 0 auto" class="app-user container-fluid ">
    <div class="container">
