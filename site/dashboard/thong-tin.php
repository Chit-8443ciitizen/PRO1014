<style>
   ...
   .app-detail-bottom__item-comment-content-form{
      /* background-color: aquamarine; */
      margin: 10px 0;
      line-height: 20px;
   }
   .app-detail-bottom__item-comment-content-form .row{
      display: flex;
      flex-direction: row;
      justify-content: space-around;
   }
   .app-detail-bottom__item-comment-content-form .row-left,
   .app-detail-bottom__item-comment-content-form .row-right {
      display: flex;
      flex-direction: column;
      justify-content: space-around ;
   }
   .app-detail-bottom__item-comment-content-form .form-group{
      line-height: 20px;
   }
   .app-detail-bottom__item-comment-content-form .form-group input{
      line-height: 30px;
   ...
   <div class="app-user-content__item-detail">
      ...
      <div class="app-user-content__item-detail-content">
         <div class="app-detail-bottom__item-comment-content-form">
            <div class="" style="text-align: center; font-size:larger"> <span class=""><strong>Cập nhật thông tin của bạn</strong></span></div>
