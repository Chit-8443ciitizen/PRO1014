...
if (exist_param("dang-ky")) {
  $VIEW_NAME = "tai-khoan/dang-ky1.php";
  ...
  try {
    ...
    if (count($MESSAGE) == 0) {
      ...
      $VIEW_NAME = "tai-khoan/dang-nhap1.php";
    } else {
      $VIEW_NAME = "tai-khoan/dang-ky1.php";
    }
  } catch (Exception $exc) {
    ...
    if (isset($_POST['email'])) {
      ...
      if ($data) {
        ...
        try {
          ...
          $mail->Username = 'hoahmpd06987@fpt.edu.vn';  // sender gmail host              
          $mail->Password = 'pevupqufusoaiatg'; // sender gmail host password                          
          $mail->SMTPSecure = 'tls';  // for encrypted connection                           
          $mail->Port = 587;   // port for SMTP     

          $mail->setFrom('hoahmpd06987@fpt.edu.vn', "Admin"); // sender's email and name
