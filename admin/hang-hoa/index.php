...
if (exist_param("btn_list")) {
  ...
  try {
    ...
    if (count($MESSAGE) == 0) {
      hang_hoa_update($ten_hang_hoa, $don_gia,floatval(str_replace(',', '.', $giam_gia)), $hinh_anh_upload, DateTime::createFromFormat("m/d/Y", $ngay_nhap)->format('Y-m-d H:m:s'), $loai_hang,  $mo_ta, $ma_hh);
      $MESSAGE = "Cập nhật sản phẩm " . $ten_hang_hoa . " thành công";
      unset($ten_hang_hoa, $don_gia, $giam_gia, $hinh_anh_upload,$ngay_nhap, $loai_hang,  $mo_ta);
